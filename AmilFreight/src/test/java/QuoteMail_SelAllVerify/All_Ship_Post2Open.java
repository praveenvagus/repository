...
public class All_Ship_Post2Open extends BaseClass
{

	public All_Ship_Post2Open(WebDriver driver) {
		super(driver);
	}
	...
	public static void PostLoad_ShipmentGUID(String sTestCaseName) throws Exception
	{
		...
		String Shipper_Name = ExcelUtils.getCellData(iTestCaseRow, Constant.AllMail_ShipperName);
		String Pickup_Location = ExcelUtils.getCellData(iTestCaseRow, Constant.AllMail_Pickup_Location);
		String Delievery_Loc=ExcelUtils.getCellData(iTestCaseRow, Constant.AllMail_Delievery_loc);
	...
	Thread.sleep(1500);
	ExcelUtils.setCellData(thomas, iTestCaseRow, Constant.AllMail_ShipMentID);
	...
	if(rplcSpace.equalsIgnoreCase(stringWithoutSpaces1)) {
		...
		driver.close();
		 ExcelUtils.setCellData(Shipper_GUID, iTestCaseRow, Constant.AllMail_Shipment_GUID);
