...
public class Mail_Recipents extends BaseClass
{

	public Mail_Recipents(WebDriver driver) {
		super(driver);
	}
	...
	public static void PostLoad_ShipmentGUID(String sTestCaseName) throws Exception
	{
		...
		System.out.println("Raajathi Raaja");
		...
		System.out.println("Rathi");

		String Shipper_Name = ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_ShipperName);
		String Trailer_Type = ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_Trailer_Type);
		String Dispatch_Exec = ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_Dispatch_Exec);
		String Pickup_Location = ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_Pickup_Location);
		String Delievery_Loc=ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_Delievery_loc);
		//String Post_Result = ExcelUtils.getCellData(iTestCaseRow, Constant.MailRecep_LoadResult);
...
System.out.println(driver.getCurrentUrl());
	System.out.println("Kathirvel Rama3 Moorthy");
	
	  // driver.findElement(By.xpath("//*[@id='shipmentdashboardlist']/div/div[2]/a")).click();
	   Thread.sleep(2500);
		System.out.println("Kathirvel Rama5 Moorthy"); 
		...
		System.out.println("Kathirvel Rama6 Moorthy"); 	
	...
	Thread.sleep(3500);
	System.out.println("Kathirvel Rama Moorthy");
	...
	ExcelUtils.setCellData(thomas, iTestCaseRow, Constant.MailRecep_ShipMentID);
	...
	if(rplcSpace.equalsIgnoreCase(stringWithoutSpaces1)) {
		...
		driver.close();
		 ExcelUtils.setCellData(Shipper_GUID, iTestCaseRow, Constant.MailRecep_Shipment_GUID);
	...
	Thread.sleep(3000);
	//if(driver.findElement(By.xpath("//*[contains(text(),'"+thomas+"')]//parent::div//parent::div//parent::div/div[2]/span/span")).isDisplayed()){
	...
	Thread.sleep(1500);
		...
		Thread.sleep(2500);
	/*	driver.findElement(By.xpath("//*[contains(text(),'"+thomas+"')]//parent::div//parent::div//parent::div/div[7]/div[1]/a[@title='Re-bid']")).click();
		Utils.Instance_NewWindow(driver);
		...
		Thread.sleep(3000);
		Utils.Instance_NewWindow(driver);
		System.out.println(driver.getCurrentUrl()+"9999999999");
