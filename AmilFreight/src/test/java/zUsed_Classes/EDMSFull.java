...
public class EDMSFull {
	static WebDriver driver;
	@Test
	public void edms_Complete() throws InterruptedException
	{
		System.setProperty("webdriver.chrome.driver", "C:\\Users\\User\\git\\AmilFreight\\drivers\\chromedriver.exe");
		driver = new ChromeDriver();
		driver.manage().window().maximize();
		Thread.sleep(3000);
		driver.navigate().to("http://stage.amilfreight.com/shipment/details/a88003c2-20ab-418a-b82a-a9f583efb109");//Need To Change
		Thread.sleep(1900);
		...
		driver.navigate().to("http://stage.amilfreight.com/shipment/details/b97bf04f-e980-4f0f-a595-726e9da13ecd");
		Thread.sleep(3333);
		
		JavascriptExecutor js=(JavascriptExecutor)driver;
		
		//Driver Details
		String Driver_Name="cap Driver01"; //Need To Change
		String Driver_PhNo="1029384722"; //Need To Change
		
		//Truck Details		
		String Truck_No="captn05"; //Need To Change
		
		//Trailer Details
		String TrailerName="captr06"; //Need To Change
	...
	public void dateMethod(String xpath)
	{
