...
public class Shipment_Post extends BaseClass
{

	public Shipment_Post(WebDriver driver) {
		super(driver);
	}
	...
	public static void PostLoad_ShipmentGUID(String sTestCaseName) throws Exception
	{
		...
		String Shipper_Name = ExcelUtils.getCellData(iTestCaseRow, Constant.Notes_ShipperName);
		String Pickup_Location = ExcelUtils.getCellData(iTestCaseRow, Constant.Notes_Pickup_Location);
		String Delievery_Loc=ExcelUtils.getCellData(iTestCaseRow, Constant.Notes_Delievery_loc);
