...
@Test(priority = 2)
public void ShipmentNotes_AmilFreight() throws Exception 
{
	Shipment_Post.PostLoad_ShipmentGUID("Notes_Ship");
	Notes_Shipment.Notes_Verification("Notes_Ship");
}
