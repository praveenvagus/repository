...
public class Locators_CarrieSignup extends BaseClass_OpenBrowser {
	    ...
	    public static WebElement SignupSections() throws Exception{
	     try{ 
	    	 //
	         //   
	    	 element = driver.findElement(By.xpath("//*[@id='main-nav']/div/div[2]/div[3]/div/ul/li[2]/a"));
	    	 }catch (Exception e){
	  ...
	  //SignupSection - Carrier Link
	    public static WebElement Signup_Carrier() throws Exception{
	     try{ 
	    	 //
	         //   
	    	 element =driver.findElement(By.xpath("//*[@id='main-nav']/div/div[2]/div[3]/div/ul/li[2]/ul/li[2]/a"));
	        }catch (Exception e){
