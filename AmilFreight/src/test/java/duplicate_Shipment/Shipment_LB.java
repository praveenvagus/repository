...
public class Shipment_LB extends BaseClass {
	...
	public static void PostLoad_ShipmentGUID(String sTestCaseName) throws Exception
	{
	    ...
	    Thread.sleep(2500);
	    driver.navigate().refresh();  Thread.sleep(2700);

		DOMConfigurator.configure("log4j.xml");
		ExcelUtils.setExcelFile(Constant.Path_TestData + Constant.File_TestData,"DuplicatShip");
	  ...
	  ShipDash_Post.Pick_Package_Count().sendKeys("750");
	    ...
	    driver.findElement(By.xpath("//*[@id='txtshippername']")).clear();
